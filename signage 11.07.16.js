            ...
            try
            {
                ...
                if (closed || !Lab.OpenNow) {
                    ...
                    if (closed && closeMessage != null) {
                        ...
                        //$("#A div div:nth-child(2)").append("<br />until <b>xx</b> for <b>yy</b></p>");
                        //TODO: Close time until?
                    }

                    //Increasing width of div if occupancy doesn't need to be displayed
                    $(LabName + " .status").removeClass("col-md-5").addClass("col-md-10");
                    ...
                    if (BookDay == CurrentDay) {
                        ...
                        $occupancy.find("h4").html("Booked&nbsp;Now");
                        $occupancy.find("p").text("for " + BookInfo + " until " + BookFinish.substring(0,10));
                    }
                    ...
                    $(LabName + " .status").removeClass("col-md-10").addClass("col-md-5");
                    ...
                    if (nextBooking != null) {
                        ...
                        if (startTime.substring(0,10) == GetDate()) {
                            //$("#" + LabName + " .col-md-5").find("p").text("Next booking: " + startTime.substring(11,16) + " - " + finishTime.substring(11,16));
                            $(LabName + " .col-md-5").find("p").html("Booked:&nbsp;" + startTime.substring(11,16) + "&nbsp;-&nbsp;" + finishTime.substring(11,16));
                        }
                    }

                    //Displays the next lab booking if any fall on the current day
                    /*$.each(Lab.Bookings, function (i, Booking) {
                     var startTime = Booking.StartTime;
                     var finishTime = Booking.FinishTime;
                     if (startTime.substring(0,10) == GetDate()) {
                     //$("#" + LabName + " .col-md-5").find("p").text("Next booking: " + startTime.substring(11,16) + " - " + finishTime.substring(11,16));
                     $("#" + LabName + " .col-md-5").find("p").html("Booked:&nbsp;" + startTime.substring(11,16) + "&nbsp;-&nbsp;" + finishTime.substring(11,16));
                     return false;
